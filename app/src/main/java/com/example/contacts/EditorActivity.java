...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private String mType = Contact.TYPEOFCONTACT_PERSONAL;
    ImageView mPhoto;
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.homephone))) {
                        mType = Contact.TYPEOFCONTACT_HOME;
                    } else if (selection.equals(getString(R.string.workphone))) {
                        mType = Contact.TYPEOFCONTACT_WORK;

                    } else {
                        mType = Contact.TYPEOFCONTACT_PERSONAL;
                    }
                }
            }
    ...
    private boolean saveContact() {
        ...
        if (mCurrentContactUri == null && TextUtils.isEmpty(name)
                && TextUtils.isEmpty(email) && TextUtils.isEmpty(phone) && mType == Contact.TYPEOFCONTACT_PERSONAL && mPhotoUri == null) {
